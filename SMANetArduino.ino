...
void writeSMANET2SingleByte(unsigned char *btbuffer, const unsigned char v) {
...
void writeSMANET2Array(unsigned char *btbuffer, const unsigned char bytes[],byte loopcount) {
...
void writeSMANET2ArrayFromProgmem(unsigned char *btbuffer,const prog_uchar ProgMemArray[],byte loopcount) {
